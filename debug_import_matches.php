...
$execution = $service->importMatches($club, $user);
echo 'MATCHES_RESULT=' . $execution->result . PHP_EOL;
echo 'MATCHES_DETAILS=' . json_encode($execution->details, JSON_UNESCAPED_UNICODE | JSON_UNESCAPED_SLASHES) . PHP_EOL;
